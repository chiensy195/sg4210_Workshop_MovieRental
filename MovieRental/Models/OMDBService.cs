...
namespace MovieRental.Externals
{
    public class OMDBService
    {
        ...
        {   
            WebRequest req = WebRequest.Create(@"http://www.omdbapi.com/?apikey=b7186d3a&t=" + Title);
            req.Method = "GET";
            ...
            if (resp.StatusCode == HttpStatusCode.OK)
            {
                ...
                //Mapper.CreateMap<MovieModel, Movie>(); //New AutoMapper Version does not support this way anymore
                //New way to create mapper
